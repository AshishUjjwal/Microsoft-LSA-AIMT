...
import EditEventForm from '../EventSection/EventModals/EditEvent.jsx'; // Import the EditEventForm component
import DeleteEvent from '../EventSection/EventModals/DeleteEvent.jsx'; // Import the DeleteEvent component
      ...
      >
        ...
        <HStack mt={3} justify={'right'}>
          ...
          {event.status === "Upcoming" && (
            ...
            >
              {/* Fill The Form */} VIEW REGISTRATIONS
            </Button>
          )}
